...
function Navbar() {
  ...
  return (
    <nav className="flex justify-between items-center  mx-auto border border-slate-400 p-4 font-mono ">
      <div className="w-full md:w-auto">
        <div className="flex justify-between items-center">
          <Link to="/">
            <div className="logo font-bold text-xl text-blue-900">
              Shivam Armarkar
            </div>
          </Link>
          ...
          <div>
            <button
              ...
              type="button"
              className="bg-blue-900 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        <div className="mobile md:hidden">
          {open && (
            <div className="px-1 pt-2 pb-3 sm:">
              <div id="navbar-default" className="flex flex-col gap-4 ">
                ...
                <Link to="/projects" className="px-2 flex text-orange-700">
                  <svg
                    className="mx-1  text-orange-700"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    width={24}
                    height={24}
      ...
      {/* web navbar */}
      <div id="navbar-default" className="hidden md:flex gap-4 ">
        <a href="#skills" className="px-2">
          Skills
        </a>
        <a href="#experience" className="px-2">
